...
<html>
  <head>
    ...
    <meta name="description" content="countdownTimer">
    <meta name="author" content="Ratinan Lee">
    <title>Test countdownTimer</title>
  ...
  <body>
    <header class="p-3 bg-dark text-white">
      <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          <b style="font-size:1.5em">countdownTimer</b>
        </div>
      </div>
    </header>
    <div class="container mt-5">
      <div class="row">
        <div class="col">
          <a href="https://github.com/lee-ratinan/countdownTimer" class="btn btn-warning mb-2" target="_blank">
